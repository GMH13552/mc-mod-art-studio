...
- Images: top=`tests/runs/v2/glowstone/resourcepack/assets/demo/textures/block/q_836777f3_top.png`, side=`tests/runs/v2/glowstone/resourcepack/assets/demo/textures/block/q_836777f3_side.png`, bottom=`tests/runs/v2/glowstone/resourcepack/assets/demo/textures/block/q_836777f3_bottom.png`
- Size: `16x16`
